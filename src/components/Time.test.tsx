...
describe('Time component', () => {
    ...
    it('copies text to clipboard on click', async () => {
        ...
        await waitFor(() => expect(screen.getByTestId('copy-snackbar-message')).toBeInTheDocument());
    });
    ...
    it('closes snackbar after timeout', async () => {
        ...
        await waitFor(() => expect(screen.queryByTestId('copy-snackbar-message')).not.toBeInTheDocument());
    });
